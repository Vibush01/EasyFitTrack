    ...
    return (
        <div className="min-h-screen bg-[var(--bg-primary)] flex items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-300">
            ...
            <motion.div
                ...
                animate="visible"
                variants={fadeIn}
                className="relative bg-[var(--bg-card)]/80 border border-[var(--border-color)] p-6 sm:p-10 rounded-3xl shadow-2xl w-full max-w-md backdrop-blur-md my-8"
            >
                <motion.div variants={fadeIn} className="text-center mb-8 sm:mb-10">
                    ...
                    <p className="text-[var(--text-secondary)] text-sm sm:text-base">Register your gym and manage members</p>
                </motion.div>
